...
class XGTOperations:
    ...
    def get_schema(
        ...
        try:
            with self.connection() as conn:
                ...
                if frames is None:
                    node_frames = conn.get_frames(namespace=dataset_name, frame_type="vertex")
                    edge_frames = conn.get_frames(namespace=dataset_name, frame_type="edge")
                else:
        ...
        try:
            with self.connection() as conn:
                ...
                for ds_name in ds_names:
                    try:
                        vertex_frames = conn.get_frames(namespace=ds_name, frame_type="vertex")
                        edge_frames = conn.get_frames(namespace=ds_name, frame_type="edge")
                        table_frames = conn.get_frames(namespace=ds_name, frame_type="table")
    ...
    def get_query_answer(self, job_id: int, offset: int = 0, length: int = 10000) -> dict:
        """
