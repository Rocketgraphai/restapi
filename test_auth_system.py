...
class APITester:
    ...
    def test_endpoint(self, name: str, method: str, endpoint: str, 
                     ...
                     use_auth: bool = False) -> Optional[Dict]:
    ...
    def authenticate_pki(self, cert_path: str, key_path: str, 
                        ca_path: Optional[str] = None,
                        server_cn: Optional[str] = None) -> bool:
    ...
    def run_comprehensive_tests(self):
        ...
        self.log_info(f"Access token (expires in 1 hour):")
